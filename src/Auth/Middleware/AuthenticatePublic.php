...
/**
 * Authenticate Public Middleware.
 *
 * Ensures that the user is authenticated for public context.
...
class AuthenticatePublic
{
    ...
    public function handle(Request $request, Closure $next, ?string $guard = null): mixed
    {
        ...
        if ($guard === null) {
            $guard = config('canvastack-rbac.contexts.public.guard', 'web');
        }
    ...
    protected function redirectTo(Request $request): ?string
    {
        ...
        $loginUrl = config('canvastack-rbac.contexts.public.login_url');
