...
class AuthController extends Controller {
	...
	public function __construct() {
		...
		if ($currentRoute) {
			...
			// Fallback when route is not available (e.g., during route:list)
			$this->authRouteInfo['current_path'] = null;
			$this->authRouteInfo['module_name'] = 'Auth';
			$this->authRouteInfo['page_info'] = 'auth';
			$this->authRouteInfo['controller'] = 'AuthController';
		}
